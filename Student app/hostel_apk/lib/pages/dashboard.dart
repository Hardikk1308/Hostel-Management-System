...
import 'package:hostel_apk/pages/Homepage_element/Leave/Leave_types.dart';
import 'Homepage_element/Attendance.dart';
import 'Homepage_element/Roomdetails.dart';
import 'Homepage_element/complain_new.dart';
...
class Dashboards extends StatefulWidget {
  ...
  const Dashboards(
      ...
      required this.user}); // Add user to the constructor
              ...
              children: [
                _buildDashboardCard(
                  ...
                  onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => const Attendece()),
                  ),
                ),
                _buildDashboardCard(
                  title: 'Room Details',
